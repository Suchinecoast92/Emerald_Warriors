...
public enum MercenaryRank {
    ...
    RECRUIT(           "cobre",   20,  1.00,   0.00,   8,       16,       6,      6,      0.20),
    SOLDIER(           "hierro",  24,  1.05,   0.05,  12,       20,       7,      8,      0.22),
    SENTINEL(          "oro",     26,  1.10,   0.10,  14,       24,       8,     10,      0.25),
    VETERAN(           "esmeralda", 30, 1.15,  0.20,  16,       28,       9,     11,      0.28),
    ANCIENT_GUARD(     "diamante", 36, 1.25,   0.30,  18,       32,      10,     12,      0.30);
